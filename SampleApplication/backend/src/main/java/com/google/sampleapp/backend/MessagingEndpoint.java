...
import static com.google.sampleapp.backend.OfyService.ofy;
...
public class MessagingEndpoint {
    ...
    public void sendMessage(@Named("message") String message) throws IOException {
        ...
        RegistrationRecord record = (RegistrationRecord) ofy().load().type(RegistrationRecord.class).filter("fbId",friend_fb_id).first().now();
