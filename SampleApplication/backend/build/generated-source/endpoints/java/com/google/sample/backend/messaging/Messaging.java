...
public class Messaging extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @return the request
   */
  public Send send(java.lang.String message) throws java.io.IOException {
    Send result = new Send(message);
    initialize(result);
    return result;
  }
  ...
  public class Send extends MessagingRequest<Void> {
     ...
     * @since 1.13
     */
    protected Send(java.lang.String message) {
